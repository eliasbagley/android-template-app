...
import com.rocketmade.templateapp.ui.bugreport.BugReportLens;
import com.rocketmade.templateapp.util.EmptyActivityLifecycleCallbacks;
...
public final class DebugAppContainer implements AppContainer {
  ...
  public ViewGroup bind(final Activity activity) {
    activity.setContentView(R.layout.debug_frame);
